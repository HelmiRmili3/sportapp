  ...
  static EdgeInsetsGeometry only({
    ...
    if (withResponsive) {
      return EdgeInsets.only(
          left: AppSizes.getScaledSizeHeight(left),
          right: AppSizes.getScaledSizeHeight(right),
          top: AppSizes.getScaledSizeHeight(top),
          bottom: AppSizes.getScaledSizeHeight(bottom));
    } else {
      return EdgeInsets.only(
        left: left,
        right: right,
