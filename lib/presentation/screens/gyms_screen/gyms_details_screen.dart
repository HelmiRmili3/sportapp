...
class _GymDetailScreenState extends State<GymDetailScreen> {
  ...
  Widget build(BuildContext context) {
    List<PackageModel> model = [
      PackageModel(
        name: S.of(context).monthly,
        pkg: [
          S.of(context).freeVideoCallMinutes,
          S.of(context).chatWithCoach,
          S.of(context).freeConsultation,
        ],
      ),
      PackageModel(
        name: S.of(context).yearly,
        pkg: [
          S.of(context).freeProteinShake,
          S.of(context).freeVideoCallMinutes,
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child:
            ...
            SizedBox(height: 10.h),
            CostomTitleWidget(title: S.of(context).location),
            SizedBox(height: 10.h),
            Center(
            ...
            Row(
              ...
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    CostomTextWidget(day: S.of(context).monday),
                    CostomTextWidget(day: S.of(context).tuesday),
                    CostomTextWidget(day: S.of(context).wednesday),
                    CostomTextWidget(day: S.of(context).thursday),
                    CostomTextWidget(day: S.of(context).friday),
                    CostomTextWidget(day: S.of(context).saturday),
                    CostomTextWidget(day: S.of(context).sunday),
                  ],
                ),
                SizedBox(height: 10.h),
                Column(
                  children: [
                    CostomTextWidget(day: S.of(context).workingHours),
                    CostomTextWidget(day: S.of(context).workingHours),
                    CostomTextWidget(day: S.of(context).workingHours),
                    CostomTextWidget(day: S.of(context).workingHours),
                    CostomTextWidget(day: S.of(context).workingHours),
                    CostomTextWidget(day: S.of(context).workingHours),
                    const CostomTextWidget(day: 'Off'),
                  ],
                ),
              ],
            ),
            SizedBox(height: 10.h),
            CostomTitleWidget(title: S.of(context).plans),
            SizedBox(
              height: 200,
